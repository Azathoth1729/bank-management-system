<template>
    <section>
        <el-row>
            <el-button type="primary" round class="dbr" @click="Add">添加担保人</el-button>
            <el-button type="success" round class="tj" @click="handleAdd">提交数据</el-button>
        </el-row>
            ...
            <el-tab-pane label="担保人">
                <el-table
                    ...
                    <el-table-column
                        ...
                        label="账号">
                        <template slot-scope="scope">
                            <el-input size="mini" v-model="scope.row.number" v-if="scope.row.flag" @blur="inputClick(scope.row)" v-focus></el-input>
